...
class TestPropertyService(unittest.TestCase):
    ...
    def test_get_properties_no_filters_success(self):
        ...
        # Arrange
        sample_db_return = [
            {"address": "Calle 1", "city": "Bogota", "current_status": "en_venta", "price": 100, "description": "Desc 1"},
            {"address": "Calle 2", "city": "Medellin", "current_status": "pre_venta", "price": 200, "description": "Desc 2"},
        ]
    ...
    def test_get_properties_with_city_filter(self):
        ...
        """
        sample_db_return = [
            {"address": "Calle Sol", "city": "Cartagena", "current_status": "vendido", "price": 300, "description": "Frente al mar"}
        ]
        self.mock_db_manager.fetch_all.return_value = sample_db_return
    ...
    def test_get_properties_with_year_filter(self):
        ...
        self.mock_db_manager.fetch_all.return_value = [
            {"address": "Calle Luna", "city": "Bogota", "current_status": "en_venta", "price": 150, "description": "Nuevo"}
        ]
        filters = {"year": 2022}
    ...
    def test_get_properties_empty_db_result(self):
        ...
        result = self.propertyService.get_properties(filters={"city": "CiudadInexistente"})
    ...
    def test_get_properties_transformation_to_dto(self):
        ...
        """
        sample_db_return = [
            {"address": "Av Principal", "city": "Cali", "current_status": "vendido", "price": 250, "description": "Bien ubicado"},
        ]
        self.mock_db_manager.fetch_all.return_value = sample_db_return
        result = self.propertyService.get_properties(filters={})
    ...
    def test_get_properties_key_error_in_transformation(self):
        ...
        """
        faulty_db_return = [
            {"address": "Calle Rota", "city": "ErrorCity", "price": 50, "description": "Dato incompleto"}
        ]
